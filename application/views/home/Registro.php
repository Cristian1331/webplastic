	...
	<section class="ftco-appointment ftco-section img pt-1" style="background-image: url('<?php echo base_url('images/bg_2.jpg')?>');">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate mb-5 text-center">
          	<p class="breadcrumbs mb-0"><span class="mr-2"><a href="index.html">Home <i class="fa fa-chevron-right"></i></a></span>Attorney <span><i class="fa fa-chevron-right"></i></span></p>
