...
<div class="hero-wrap" style="background-image: url('<?php echo base_url('assets/img/cajaCristiflex.jpg') ?>');" data-stellar-background-ratio="0.5">
		...
		<div class="row">
			<div class="col-md-3 d-flex align-items-stretch">
				<div class="case-wrap d-flex">
					<div class="img" style="background-image: url('<?php echo base_url('assets/img/art1.jpg')?>');">
						<div class="text">
			...
			<div class="col-md-6 d-flex align-items-stretch">
				<div class="case-wrap d-flex">
					<div class="img" style="background-image: url('<?php echo base_url('assets/img/art2.jpg')?>');">
						<div class="text">
			...
			<div class="col-md-3 d-flex align-items-stretch">
				<div class="case-wrap d-flex">
					<div class="img" style="background-image: url('<?php echo base_url('assets/img/art3.jpg')?>');">
						<div class="text">
							<h2>Aluminio</h2>
							<p></p>
						</div>
			...
			<div class="col-md-3 d-flex align-items-stretch">
				<div class="case-wrap d-flex">
					<div class="img" style="background-image: url('<?php echo base_url('assets/img/art4.jpg')?>');">
						<div class="text">
							<h2>Decorados</h2>
							<p></p>
						</div>
			...
			<div class="col-md-3 d-flex align-items-stretch">
				<div class="case-wrap d-flex">
					<div class="img" style="background-image: url('<?php echo base_url('assets/img/art5.jpg')?>');">
						<div class="text">
			...
			<div class="col-md-3 d-flex align-items-stretch">
				<div class="case-wrap d-flex">
					<div class="img" style="background-image: url('<?php echo base_url('assets/img/art6.jpg')?>');">
						<div class="text">
			...
			<div class="col-md-3 d-flex align-items-stretch">
				<div class="case-wrap d-flex">
					<div class="img" style="background-image: url('<?php echo base_url('assets/img/art7.jpg')?>');">
						<div class="text">
							<h2>Bandeja</h2>
							<p></p>
						</div>
