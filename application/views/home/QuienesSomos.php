...
<section class="hero-wrap hero-wrap-2" style="background-image: url('<?php echo base_url('assets/images/bg_5.jpg')?>');" data-stellar-background-ratio="0.5">
	<div class="overlay"></div>
	<div class="container">
		<div class="row no-gutters slider-text align-items-end justify-content-center">
			<div class="col-md-9 ftco-animate mb-5 text-center">
				<p class="breadcrumbs mb-0"><span class="mr-2"><a href="index.html">Home<i class="fa fa-chevron-right"></i></a></span> <span>Sobre nosotros<i class="fa fa-chevron-right"></i></span></p>
				<h1 class="mb-0 bread">¿Quiénes somos?</h1>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		<div class="row no-gutters">
			<div class="col-md-6 wrap-about ftco-animate">
				<div class="bg-light px-3 px-md-5 py-5 ">
					<div class="heading-section">
						...
						<h2 class="mb-3">
							Productos de calidad y fácil acceso
						</h2>

						<p>Queremos lo mejor para nuestros usuarios...</p>
					</div>
						...
						<div class="col-lg-6">
							<div class="services d-flex w-100">
								...
								<div class="text pl-2">
									...
									<p>Toallas desechables, paños humedos, jabón para manos...</p>
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="services d-flex w-100">
								...
								<div class="text pl-2">
									<h2>Para ocasiones especiales</h2>
									<p>Vasos, cubiertos, platos, servilletas...</p>
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="services d-flex w-100">
								...
								<div class="text pl-2">
									<h2>Empaques plásticos</h2>
									<p>Bolsas transparentes de cualquier tamaño.</p>
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<div class="services d-flex w-100">
								...
								<div class="text pl-2">
									<h2>¿Para llevar?</h2>
									<p>Bolsas de manija T15, T20, T25...</p>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="col-md-6 d-flex align-items-stretch">
				<div class="img img-3 w-100 d-flex justify-content-center align-items-center" style="background-image: url('<?php echo base_url('assets/img/banner.jpg')?>'); position: relative;">
					<a href="https://www.youtube.com/watch?v=h2FyJqqc_dc" class="play-video popup-vimeo d-flex align-items-center justify-content-center">
...
<section class="ftco-section ftco-no-pb ftco-no-pt">
	<div class="container">
		<div class="row no-gutters">
			<div class="col-md-6 d-flex align-items-stretch">
				<div class="img img-3 w-100 d-flex justify-content-center align-items-center" style="background-image: url('<?php echo base_url('assets/img/plasticos.gif')?>'); position: relative;">
					<a href="https://www.youtube.com/watch?v=zbBoeB9-kW8" class="play-video popup-vimeo d-flex align-items-center justify-content-center">
						<span class="fa fa-play"></span>
					</a>
				</div>
			</div>
			<div class="col-md-6 wrap-about ftco-animate">
				<div class="bg-light px-3 px-md-5 py-5 ">
					<div class="heading-section">
						<span class="subheading">Juntos podremos mejorar nuestro mundo</span>
						<h2 class="mb-3">
